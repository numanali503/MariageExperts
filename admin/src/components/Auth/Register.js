...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await fetch(`${authURL}/admin-registration`, {
                method: "POST",
                headers: {
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <div className="flex items-end justify-between">
                        ...
                        <p className="mt-3 text-xs text-end text-gray-800 flex-col flex">
                            ...
                            >
                                <i class="fa-duotone fa-light fa-arrow-up-right-from-square text-[9px]"></i> Sign In Here
                            </Link>
                        </p>
                    </div>
                </form>
