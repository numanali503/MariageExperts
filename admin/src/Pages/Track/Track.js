...
function Track() {
    ...
    const addTimelineStep = async () => {
        ...
        try {
            const response = await fetch(`${authURL}/update-proposal?proposalCode=${proposalCode}`, {
                method: 'PUT',
                headers: {
                ...
                <div className="flex items-center gap-4 mb-8">
                    <div className="relative flex-1">
                        <input
                            ...
                            className="w-full py-3 px-4 pl-12 rounded-lg border border-rose-200 focus:border-rose-500 focus:ring-2 focus:ring-rose-200 outline-none transition-all uppercase"
                        />
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex justify-between items-start">
                            <div>
                                ...
                                <span className={`px-4 py-1.5 rounded-full text-sm font-medium ${getStatusColor(proposal.status)}`}>
                                    {proposal.status}
                                </span>
                            </div>
                        ...
                        <div className="relative">
                            ...
                            <div className="mb-8 flex gap-2">
                                <input
                                    ...
                                    className="flex-1 py-2 px-8 rounded-lg border border-rose-200 focus:border-rose-500 focus:ring-2 focus:ring-rose-200 outline-none"
                                />
                                <button
