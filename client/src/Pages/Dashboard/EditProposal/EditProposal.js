...
const Track = () => {
    ...
    const ImageGallery = ({
        ...
        return (
            <div className="space-y-4">
                <div
                    className={`relative flex items-center justify-center ${aspectRatio === "square" ? "aspect-square" : "h-96"}`}
                >
                    <img
                    ...
                    <div className="flex justify-center gap-2">
                        {images.map((_, index) => (
                            <button
                                ...
                                className={`w-2 h-2 rounded-full ${currentIndex === index ? "bg-rose-950" : "bg-gray-300"}`}
                            />
                        ))}
                    </div>
                )}
    ...
    <div className="space-y-4">
        {proposal.agentAssigned && proposal.agentAssigned.length > 0 ? (
