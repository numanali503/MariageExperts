...
const Form = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setUploading(true);
    try {
      const response = await fetch(`${authURL}/post-proposal`, {
        method: "POST",
        headers: {
      ...
      if (response.ok) navigate("/dashboard/history");
    } catch (error) {
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <div className="flex items-center justify-between">
                  ...
                  <h1 className="text-xs text-rose-800 text-end">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Ahl-e-Tashee">Ahl-e-Tashee</option>
                      <option value="Practicing Muslim">
                        Practicing Muslim
                      </option>
                    </select>
                  </div>
              ...
              <div className="flex items-center mb-4">
                ...
                >
                  ...
                  <a
                    ...
                    className="text-rose-600 hover:text-rose-800 font-semibold underline decoration-2 underline-offset-2 transition-colors duration-200"
                  >
