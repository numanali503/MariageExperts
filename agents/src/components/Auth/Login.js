...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            const response = await fetch(`${authURL}/agents-login`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
                body: JSON.stringify({ agentCode: username, password }),
            });
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <div className="flex items-end justify-between">
                        ...
                        <p className="mt-3 text-xs text-end text-gray-800 flex-col flex">
                            ...
                            >
                                <i class="fa-duotone fa-light fa-arrow-up-right-from-square text-[9px]"></i> Register Here
                            </Link>
                        </p>
                    </div>
                </form>
